        ...
        body: Column(
          children: [
            ...
            BoxWidget(
              ...
              description:
                  'Add Math Form 4_notes.pdf, English Communication Learning video...',
            ...
            BoxWidget(
              ...
              description:
                  'Add Math Form 4_notes.pdf, Add Math Form 5_notes, Differentiation Tutorial...',
              iconData: Icons.folder_copy_outlined,
              onPressed: () {
                //Add navigation logic
                Navigator.push(context,
                    MaterialPageRoute(builder: (context) => AddMathNotes()));
              },
            ),
            SizedBox(height: 15),
            BoxWidget(
              subject: 'English',
              description:
                  'Form 4 Vocab list, Grammar, 100 SPM Essays Essentials... ',
              iconData: Icons.folder_copy_outlined,
              onPressed: () {
                //Add navigation logic
              },
            ...
            BoxWidget(
              ...
              description:
                  'Koleksi Kertas Percubaan SPM, 100 Peribahasa, My_notes.pdf...',
              iconData: Icons.folder_copy_outlined,
              onPressed: () {
                //Add navigation logic
              },
            ...
            BoxWidget(
              subject: 'Sejarah',
              description:
                  'Koleksi Kertas Percubaan SPM, Form 4 Chapter 10 notes, My_notes.pdf...',
              iconData: Icons.folder_copy_outlined,
              onPressed: () {
                //Add navigation logic for
              },
            ),
            SizedBox(height: 15),
            BoxWidget(
            ...
            SizedBox(height: 15),
            // Add spacing between the content and the buttons
            Padding(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            ...
            SizedBox(width: 10),
            //Add spacing between icon and subject (horizontally)
            Expanded(
              child: Column(
