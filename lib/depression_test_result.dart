            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 10),
                  Text(
                    'Your overall score on the depression test falls within the normal range, suggesting that you are currently not experiencing significant symptoms of depression. This is positive news and indicates that you are in good emotional health.',
                    style: TextStyle(
                      fontSize: 14,
                      color: Colors.black,
                    ),
        ...
        Container(
          ...
          child: Center(
            child: CircularProgressIndicator(
              ...
              backgroundColor: Color.fromARGB(255, 192, 253, 198),
              valueColor: AlwaysStoppedAnimation<Color>(
                  Color.fromARGB(255, 99, 246, 47)),
              strokeWidth: 150.0,
              semanticsLabel: '',
            ),
          ),
