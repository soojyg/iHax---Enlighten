                  ...
                  children: [
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: Color.fromARGB(255, 186, 254, 193),
              ...
              child: Column(
                children: [
                        ...
                        text: TextSpan(
                          ...
                          children: <TextSpan>[
                            TextSpan(
                              ...
                              style: TextStyle(
                                fontSize: 12,
                                // Adjust the font size of the subscript
                  ...
                  Container(
                    ...
                    height: 40,
                    decoration: BoxDecoration(
                      color: Color.fromARGB(255, 221, 247, 224),
                      // Background color of the box
                      borderRadius:
                          BorderRadius.circular(10), // Rounded corners
                    ),
                    child: Row(
                      ...
                      children: [
                        Text(
                          'Give your learning materials a special name.',
                          style: TextStyle(
                            fontSize: 12,
