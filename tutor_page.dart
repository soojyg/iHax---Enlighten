            ...
            children: [
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  fixedSize: Size(180, 40), // Adjust the button size as needed
                ),
                child: Row(
        ...
        Padding(
          ...
          Container(
            ...
            decoration: BoxDecoration(
              shape: BoxShape.rectangle, // You can use BoxShape.rectangle for rounded corners
              borderRadius: BorderRadius.circular(10), // Adjust the radius as needed
              color: Color.fromARGB(255, 110, 219, 93), // Your background color
            ),
            child:
                Padding(
                  padding: EdgeInsets.all(5),
                  child:
                    Row(
                      ...
                      children:[
                      Text('Form 4 English Class Starts in 5 minutes',
                      style: TextStyle(
                        color: Colors.black,
                        fontSize: 12,
                      ),
                        ...
                        ElevatedButton(
                          onPressed: () {
                            Navigator.push(context,MaterialPageRoute(builder: (context) => MeetingRoom()));
                          },
                          style: ElevatedButton.styleFrom(
                            primary: Colors.white,
                            // fixedSize: Size(60, 40), // Adjust the button size as needed
                          ),
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.center,
                            children: [
...
class CircleWithRectangleForm extends StatefulWidget {
  @override
  _CircleWithRectangleFormState createState() => _CircleWithRectangleFormState();
}
